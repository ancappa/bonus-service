package it.tim.bonus.controller.component;
...
public class DiagnosticsComponent implements Ordered {
	...
	private static final Logger logger = LoggerFactory.getLogger(it.tim.bonus.controller.component.DiagnosticsComponent.class);
	
	
	@SuppressWarnings("unchecked")
	@Around("execution(* it.tim.bonus.web.BonusController.*(..))")
